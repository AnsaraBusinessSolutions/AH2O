...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
                    ...
                    <input type="text" name="form_template_name" id="form_template_name" value="">
        </div>
        <div class="col-md-4">
                     <button class="btn btn-primary" name="save_form_template" id="save_form_template" value="Save">Save Form</button>
...
<!-- Modal -->
    ...
    <div class="modal" id="dataAlterModal" aria-hidden="true" aria-labelledby="dataAlterModalLabel" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="dataAlterModalLabel">Modal title</h5>
